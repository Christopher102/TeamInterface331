{-
 -  HOPL/CHECKED_STATEMENT/Environment.hs
 -
 ...
 -}
module HOPL.CHECKED_STATEMENT.TypeEnv (TEnv (..), TypeEnvironment, Type (..)) where

import Data.List
import Data.Maybe
import HOPL.CHECKED_STATEMENT.DataStructures
